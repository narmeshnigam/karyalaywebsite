...
/**
 * Invoice Page
 * Display and download invoice for an order
 * A4 paper format for printing
 */
...
if (!$invoice) {
    $_SESSION['error'] = 'Invoice not found or order is not completed.';
    header('Location: ' . get_app_base_url() . '/app/billing/history.php');
    exit;
}
...
// Build logo URL - check if logo exists in settings, otherwise use default
$logoUrl = '';
    ...
    <style>
        ...
        * {
        ...
        @media print {
            ...
            /* Maintain two-column layouts in print */
            .invoice-header {
...
<body>
    <div class="invoice-wrapper">
        ...
        <div class="invoice-actions">
            <a href="<?php echo get_app_base_url(); ?>/app/billing/history.php" class="btn btn-secondary">
                ← Back to Orders
            </a>
            <div class="btn-group">
        ...
        <div class="invoice-paper">
            ...
            <div class="invoice-parties">
                ...
                <div class="invoice-party">
                    <h3>Billed To</h3>
                    <!-- Order: Name, Business Name, Address, Contact, Tax ID -->
