...
/**
 * Test Module class structure and method signatures
 */
class ModuleClassStructureTest extends TestCase
{
    public function testModuleClassExists(): void
    {
        $this->assertTrue(class_exists(Module::class), 'Module class should exist');
    }

    public function testModuleClassHasRequiredMethods(): void
    {
        ...
        foreach ($requiredMethods as $method) {
            $this->assertTrue(
                ...
                "Module class should have {$method} method"
            );
        }
    }

    public function testModuleCreateMethodSignature(): void
    {
        $reflection = new ReflectionClass(Module::class);
    ...
    public function testModuleFindByIdMethodSignature(): void
    {
        $reflection = new ReflectionClass(Module::class);
    ...
    public function testModuleFindBySlugMethodSignature(): void
    {
        $reflection = new ReflectionClass(Module::class);
    ...
    public function testModuleUpdateMethodSignature(): void
    {
        $reflection = new ReflectionClass(Module::class);
    ...
    public function testModuleDeleteMethodSignature(): void
    {
        $reflection = new ReflectionClass(Module::class);
    ...
    public function testModuleFindAllMethodSignature(): void
    {
        $reflection = new ReflectionClass(Module::class);
    ...
    public function testModuleSlugExistsMethodSignature(): void
    {
        $reflection = new ReflectionClass(Module::class);
