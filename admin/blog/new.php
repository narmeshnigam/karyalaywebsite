...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!validateCsrfToken()) {
        ...
        $form_data['author_id'] = $_SESSION['user_id'] ?? null;
        ...
        if (empty($form_data['author_id'])) {
            $errors[] = 'Author information is missing. Please log in again.';
        }
        ...
        if (empty($errors)) {
            $result = $contentService->create('blog_post', $form_data);
...
include_admin_header('Create Blog Post');
?>
...
<div class="admin-page-header">
    <div class="admin-page-header-content">
        ...
        <h1 class="admin-page-title">Create New Blog Post</h1>
            ...
            <div class="admin-card">
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <p class="form-help">Auto-generated from title if left empty</p>
                    </div>
                </div>
            </div>
            ...
            <div class="admin-card">
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <p class="form-help">Short description shown in blog listings. If empty, auto-generated from content.</p>
                    </div>
                </div>
            </div>
        </div>
