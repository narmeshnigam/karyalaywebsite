        ...
        <div class="form-section">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" id="name" name="name" class="form-input" 
                        ...
                        required maxlength="255" placeholder="e.g., Inventory Management">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="slug" name="slug" class="form-input" 
                        ...
                        pattern="[a-z0-9\-]+" maxlength="255" placeholder="e.g., inventory-management">
            ...
            <div class="form-group">
                ...
                <textarea id="description" name="description" class="form-textarea" rows="4"
                    placeholder="Brief description of what this solution does..."><?php echo htmlspecialchars($form_data['description']); ?></textarea>
                ...
                <div class="form-checkbox-group">
                    <label class="form-checkbox-label">
                        <input type="checkbox" id="featured_on_homepage" name="featured_on_homepage" 
                               ...
                               <?php echo $form_data['featured_on_homepage'] ? 'checked' : ''; ?>>
        ...
        <div class="form-section">
            ...
            <div class="form-group">
                ...
                <textarea id="benefits" name="benefits" class="form-textarea form-textarea-code" rows="8"
                    placeholder='[&#10;  {"title": "Increase Efficiency", "description": "Streamline your workflow and save time"}&#10;]'><?php echo !empty($form_data['benefits']) ? htmlspecialchars(json_encode($form_data['benefits'], JSON_PRETTY_PRINT)) : ''; ?></textarea>
                <p class="form-help">Enter benefits in JSON format: [{"title": "...", "description": "..."}]</p>
            </div>
        </div>
...
document.getElementById('name').addEventListener('input', function() {
    ...
    if (!slugInput.value || slugInput.dataset.autoGenerated === 'true') {
        const slug = this.value.toLowerCase().replace(/[^a-z0-9\s\-]/g, '').replace(/[\s_]+/g, '-').replace(/-+/g, '-').replace(/^-+|-+$/g, '');
