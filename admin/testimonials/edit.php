...
$testimonial = $testimonialModel->findById($testimonial_id);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!validateCsrfToken()) {
        ...
        if (empty($errors)) {
            $result = $testimonialModel->update($testimonial_id, $form_data);
...
include_admin_header('Edit Testimonial');
?>
        ...
        <div class="form-section">
            ...
            <div class="form-group">
                ...
                <textarea id="testimonial_text" name="testimonial_text" class="form-textarea" rows="6"
                    required><?php echo htmlspecialchars($form_data['testimonial_text']); ?></textarea>
