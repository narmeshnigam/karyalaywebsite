<?php
/**
 * Admin Edit Why Choose Card Page
 */
...
include_admin_header('Edit Why Choose Card');
?>
...
<div class="admin-page-header">
    <div class="admin-page-header-content">
        ...
        <h1 class="admin-page-title">Edit Card</h1>
...
.image-preview { margin-top: var(--spacing-3); }
.image-preview img { max-width: 320px; height: auto; border-radius: var(--radius-lg); border: 1px solid var(--color-gray-200); aspect-ratio: 16/9; object-fit: cover; }
@media (max-width: 768px) { .admin-page-header { flex-direction: column; } .form-row { grid-template-columns: 1fr; } .image-preview img { max-width: 100%; } }
</style>
