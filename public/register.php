...
if (is_logged_in()) {
    header('Location: /karyalayportal/app/dashboard.php');
    exit;
}
...
// Set page variables
$page_title = 'Register';
$page_description = 'Create your Karyalay account';
...
<section class="auth-section">
    <div class="auth-container">
        <div class="auth-card">
            ...
            <form method="POST" action="/karyalayportal/register.php" class="auth-form" novalidate>
                <!-- Name Field -->
                <div class="auth-form-group">
                    ...
                    <div class="auth-input-wrapper">
                        ...
                        <input 
                            ...
                            id="name" 
                            name="name" 
                            class="auth-input <?php echo isset($errors['name']) ? 'auth-input-error' : ''; ?>"
                    ...
                    <?php if (isset($errors['name'])): ?>
                        <div id="name-error" class="auth-error" role="alert">
                ...
                <div class="auth-form-group">
                    ...
                    <div class="auth-input-wrapper">
                        ...
                        <input 
                            ...
                            class="auth-input <?php echo isset($errors['password_confirm']) ? 'auth-input-error' : ''; ?>"
                    ...
                    <?php if (isset($errors['password_confirm'])): ?>
                        <div id="password_confirm-error" class="auth-error" role="alert">
                            <?php echo esc_html($errors['password_confirm']); ?>
                        </div>
                    <?php endif; ?>
                </div>
                ...
                <div class="auth-footer">
                    <p>Already have an account? <a href="/karyalayportal/login.php" class="auth-link-primary">Sign in</a></p>
                </div>
            </form>
        </div>
